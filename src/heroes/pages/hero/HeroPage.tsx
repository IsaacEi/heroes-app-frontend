...
export const HeroPage = () => {
  ...
  if (!superheroData) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-gray-500 text-3xl text-semibold">Cargando datos del héroe...</p>
      </div>
    )
  }
  ...
  return (
    <>
      {/* Breadcrumbs */}
      <CustomBreadcrumbs currentPage="Heroes" breadcrumbs={[{ label: 'Inicio', to: '/' }]} />
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-12 text-right font-bold">{superheroData?.strength ?? 0}/10</div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-12 text-right font-bold">{superheroData?.intelligence ?? 0}/10</div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-12 text-right font-bold">{superheroData?.speed ?? 0}/10</div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-12 text-right font-bold">{superheroData?.durability ?? 0}/10</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
